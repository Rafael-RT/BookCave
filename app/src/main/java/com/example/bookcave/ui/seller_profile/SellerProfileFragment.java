...
public class SellerProfileFragment extends Fragment {
    ...
    private EditText ufirstname,ulastname,uphno_owner,ushopname ,uaddress,upincode, verifyemail;
    private String semail,sfirstname,slastname,saddress,spincode,userid,sphno_owner, sshopname;
            ...
            public void onClick(View v) {
                ...
                if(updatepc.length()!=6){
                    ...
                    if(verifythis.equals(semail)) {
                        UpdateAccountInfo(updatefn,updateln,updatephnoown,updateadd,updatepc,updatesn,semail,userid);
                    }else{
    ...
    private void UpdateAccountInfo(String updatefn, String updateln, String updatephnoown, String updateadd, String updatepc, String updatesn, String semail, String userid) {
