...
public class CreatAccountSeller extends AppCompatActivity {
    ...
    EditText email,password,firstname,lastname,phno_owner,shopname,address,pincode;
    private String semail,spassword,sfirstname,slastname,saddress,spincode,userid,sphno_owner,sshopname;
